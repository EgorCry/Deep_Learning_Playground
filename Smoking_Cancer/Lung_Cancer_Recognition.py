...
def model_predict():
    ...
    shortness_of_breath = 1 if input(
        'Please enter if you have difficulties with breathing (yes or no)\n').lower() == 'yes' else 0
    swallowing_difficulty = 1 if input(
        'Please enter if you swallowing with difficulties (yes or no)\n').lower() == 'yes' else 0
